...
@implementation ITDCBarButtonItem

//实现创建文字按钮
+ (instancetype)buttonWithTitle:(NSString *)buttonTitle{
    //初始化
    ITDCBarButtonItem *barButtonItem = [super buttonWithType:UIButtonTypeSystem];
...
+ (instancetype)buttonWithImageNormal:(UIImage *)imageNormal imageSelected:(UIImage *)imageSelected{
    ITDCBarButtonItem *barButtonItem = [super buttonWithType:UIButtonTypeCustom];
